...
def desktop_dir(*paths):
  ...
  return _get_join("XDG_DESKTOP_HOME", "Desktop", *paths)

def documents_dir(*paths):
  """Get the XDG documents directory."""
  return _get_join("XDG_DOCUMENTS_HOME", "Documents", *paths)

def download_dir(*paths):
  """Get the XDG download directory."""
  return _get_join("XDG_DOWNLOAD_HOME", "Downloads", *paths)

def music_dir(*paths):
  """Get the XDG music directory."""
  return _get_join("XDG_MUSIC_HOME", "Music", *paths)

def pictures_dir(*paths):
  """Get the XDG pictures directory."""
  return _get_join("XDG_PICTURES_HOME", "Pictures", *paths)

def publicshare_dir(*paths):
  """Get the XDG public share directory."""
  return _get_join("XDG_PUBLICSHARE_HOME", "Public", *paths)

def templates_dir(*paths):
  """Get the XDG templates directory."""
  return _get_join("XDG_TEMPLATES_HOME", "Templates", *paths)

def videos_dir(*paths):
  """Get the XDG videos directory."""
  return _get_join("XDG_VIDEOS_HOME", "Videos", *paths)
